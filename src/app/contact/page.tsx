            ...
            <div className="container mx-auto px-6 py-12 lg:py-16">
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-16">
                    ...
                    <div className="space-y-12">
                        <div>
                            <h2 className="text-2xl font-black mb-6">Ways to reach us</h2>
                            <div className="space-y-8">
                                <div className="flex gap-4">
                                    ...
                                    <div>
                                        ...
                                        <span className="text-muted">support@petshack.au</span>
                                    </div>
                                </div>
                                <div className="flex gap-4">
                                    <div className="w-12 h-12 bg-primary/5 rounded-2xl flex items-center justify-center flex-shrink-0">
                                    ...
                                    <div>
                                        ...
                                        <span className="text-muted">+61 (02) 8000 0000</span>
                                    </div>
                                </div>
                                <div className="flex gap-4">
                                    <div className="w-12 h-12 bg-primary/5 rounded-2xl flex items-center justify-center flex-shrink-0">
                                    ...
                                    <div>
                                        ...
                                        <span className="text-muted">Sydney, NSW 2000, Australia</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="bg-primary p-8 rounded-3xl text-white">
                            <h3 className="text-xl font-bold mb-4">Are you a retailer?</h3>
                            <p className="text-white/70 mb-6 text-sm">Join our platform to list your products and reach more customers.</p>
                            <a href="/partners" className="inline-flex items-center gap-2 font-bold text-accent hover:underline">
                                Partner with us →
                            </a>
                        </div>
                    </div>
                    ...
                    <div className="lg:col-span-2">
                        <div className="bg-white border border-border shadow-2xl rounded-[1.5rem] lg:rounded-[2.5rem] p-6 lg:p-16">
                            <h2 className="text-2xl font-black mb-8 lg:mb-10 flex items-center gap-3">
                            ...
                            <form className="space-y-4 lg:space-y-8">
                                ...
                                <div className="space-y-2 lg:space-y-3">
                                    ...
                                    <textarea rows={5} className="w-full bg-surface border border-border rounded-xl px-4 py-2.5 lg:py-3.5 focus:ring-4 focus:ring-primary/10 focus:border-primary outline-none transition-all text-sm lg:text-base" placeholder="Tell us how we can help..."></textarea>
                                </div>
