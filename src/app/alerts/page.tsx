                            ...
                            {alerts.map((alert) => (
                                <div key={alert.id} className="p-6 sm:p-8 flex flex-col md:flex-row items-center gap-6 sm:gap-8 group hover:bg-surface/50 transition-colors">
                                    ...
                                    <div className="flex items-center gap-4 w-full md:w-auto">
                                        <Link
                                            href={`/discover?focus=${alert.id}`}
                                            className="flex-1 md:flex-none px-6 py-3 border border-border rounded-xl text-center text-[10px] font-black uppercase tracking-widest hover:bg-surface hover:text-primary hover:border-primary transition-all min-h-[44px] flex items-center justify-center whitespace-nowrap"
                                        >
                                            Compare Prices
                                        </Link>
                                        <button
