            ...
            <div className="container mx-auto px-4 sm:px-6">
                <div className="max-w-7xl mx-auto">
                    ...
                    <Link
                        ...
                        target="_blank"
                        className="group relative block w-full rounded-2xl sm:rounded-3xl lg:rounded-[3.5rem] overflow-hidden bg-surface shadow-[0_30px_100px_-20px_rgba(0,0,0,0.15)] transition-all duration-700 hover:shadow-[0_40px_120px_-20px_rgba(20,167,157,0.2)] hover:-translate-y-2 border-2 sm:border-4 border-white active:scale-[0.99]"
                    >
                        {!imageError ? (
                            <div className="relative w-full">
                                ...
                                <div className="absolute top-3 right-3 sm:top-6 sm:right-6 lg:top-10 lg:right-10 px-2 sm:px-3 py-1 bg-black/20 backdrop-blur-md rounded-md border border-white/20 text-white/80 text-[9px] sm:text-[10px] font-bold uppercase tracking-widest pointer-events-none">
                                    Ad
                                </div>
                            </div>
                        ) : (
                            /* Professional Mock State */
                            <div className="w-full aspect-21/9 lg:aspect-21/6 flex items-center justify-center bg-linear-to-br from-primary/5 to-surface text-center p-8 sm:p-12">
                                <div className="space-y-3 sm:space-y-4">
                                    ...
                                    <h3 className="text-lg sm:text-xl lg:text-2xl font-black text-foreground/40 uppercase tracking-tighter">Your Promotion Here</h3>
                                    <p className="text-xs sm:text-sm font-medium text-muted-light max-w-sm mx-auto">
