                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-10 lg:gap-12 mb-8 sm:mb-12 lg:mb-16 text-center sm:text-left">
                    ...
                    <div className="border-b sm:border-b-0 border-border pb-6 sm:pb-0">
                        ...
                        <ul className="space-y-3 sm:space-y-4 text-xs sm:text-sm font-medium flex flex-col items-center sm:items-start">
                            <li><Link href="/discover?animal=Dog" className="text-muted hover:text-primary transition-colors">Dog Products</Link></li>
                            <li><Link href="/discover?animal=Cat" className="text-muted hover:text-primary transition-colors">Cat Essentials</Link></li>
                            <li><Link href="/discover?animal=Bird" className="text-muted hover:text-primary transition-colors">Bird Care</Link></li>
                            <li><Link href="/discover?animal=Fish" className="text-muted hover:text-primary transition-colors">Aquatic &amp; Fish</Link></li>
                            <li><Link href="/discover?animal=Small Animal" className="text-muted hover:text-primary transition-colors">Small Animals</Link></li>
                        </ul>
                    </div>
